...
namespace HomeAssistant.Infrastructure.Migrations
{
    ...
    [Migration("20240330144231_added_many_to_many_relation_for_steps_recipesProducts")]
    partial class added_many_to_many_relation_for_steps_recipesProducts
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("HomeAssistant.Infrastructure.Data.Models.HomeAssistantUser", b =>
                {
                    ...
                    b.HasData(
                        new
                        {
                            ...
                            PasswordHash = "AQAAAAEAACcQAAAAELlQZCplK1vqeDGfrf10NZUqaszGoWl1RPqWLJVFiqerLc88oNp85zgKpOiNoZE5tA==",
                            PhoneNumberConfirmed = false,
                            SecurityStamp = "9e644a4e-9e00-4ac1-b509-acb1a7a87aab",
            ...
            modelBuilder.Entity("HomeAssistant.Infrastructure.Data.Models.RecipeProductStep", b =>
                {
                    b.HasOne("HomeAssistant.Infrastructure.Data.Models.RecipeProduct", "Recipe")
                        .WithMany("Steps")
